...
class Topbar extends Component {
  ...
  renderMenuTab = () => {
    ...
    return menu.map((item, index) => (
      <Tab
        ...
        classes={{ root: this.props.classes.tabItem }}
        label={item.label}
      />
    ));
  };
  ...
  current = () => {
    const menu = this.getMenu();
    const index = menu.findIndex((item) => item.pathname === this.props.currentPath);
                ...
                <React.Fragment>
                  ...
                  <div className={classes.tabContainer}>
                    <SwipeableDrawer anchor="right" open={this.state.menuDrawer} onClose={this.mobileMenuClose} onOpen={this.mobileMenuOpen}>
                      <AppBar title="Menu" />
                      <List>{this.renderMenuList()}</List>
                    </SwipeableDrawer>
                    <Tabs value={this.current()} indicatorColor="primary" textColor="primary" onChange={this.handleChange}>
                      {this.renderMenuTab()}
                    </Tabs>
                  </div>
                </React.Fragment>
